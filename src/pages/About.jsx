...
import { Target, Eye, Heart, Zap, Users, Globe, CheckCircle, Lightbulb } from 'lucide-react';
...
const About = () => {
  ...
  const coreValues = [
    { text: "Bold Innovation – We build the future before it arrives.", icon: <Zap className="w-5 h-5" /> },
    { text: "Human-Centered Intelligence – Tech should empower people.", icon: <Users className="w-5 h-5" /> },
    { text: "Accessible Excellence – High-end tools should be usable by all.", icon: <CheckCircle className="w-5 h-5" /> },
    { text: "Decentralized Empowerment – Power belongs with communities.", icon: <Globe className="w-5 h-5" /> },
    { text: "Relentless Learning – Systems evolve, and so do we.", icon: <Lightbulb className="w-5 h-5" /> },
    { text: "Global Impact, Local Roots – Global reach, with African-first focus.", icon: <Heart className="w-5 h-5" /> },
    { text: "Integrity in Execution – Dream boldly, execute precisely.", icon: <Target className="w-5 h-5" /> }
  ];
          ...
          >
            ...
            >
              ...
              >
                ...
                <span className="italic text-cyan-300">"Zen"</span> (balance) and{" "}
            ...
            >
              ...
              >
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-blue-400 font-bold text-2xl">Mission Statement</h3>
                </div>
                
                <p className="text-gray-200 leading-relaxed mb-4">
                  To build bold, intelligent technologies that empower individuals,
                  transform industries, and reimagine what's possible across finance,
                  AI, robotics, and digital services.
                </p>
                ...
                >
                  We create tools that listen, learn, evolve and uplift human potential.
                </motion.p>
              </motion.div>
            </motion.div>
            ...
            >
              ...
              >
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-purple-400 font-bold text-2xl">Vision Statement</h3>
                </div>
                
                <p className="text-gray-200 leading-relaxed mb-4">
                  To become the world's leading innovation lab for emerging technologies
          ...
          >
            ...
            >
              <div className="flex items-center mb-8">
                ...
                <h3 className="text-orange-400 font-bold text-2xl md:text-3xl">What We Stand For</h3>
              </div>
