        ...
        >
          ...
          <div className="mb-16">
            <div className="flex items-center justify-center mb-6">
              <Sparkles
                className="text-cyan-400 mr-2 animate-pulse"
                size={24}
              />
              ...
              <Sparkles
                className="text-cyan-400 ml-2 animate-pulse"
                size={24}
              />
            </div>
          </div>
            ...
            >
              ...
              <div className="space-y-6">
                {[
                  {
                    icon: Users,
                    text: "Talented builders",
                    color: "from-green-400 to-emerald-500",
                  },
                  {
                    icon: Lightbulb,
                    text: "Curious early users",
                    color: "from-yellow-400 to-orange-500",
                  },
                  {
                    icon: DollarSign,
                    text: "Mission-aligned investors",
