...
export default function ContactPage() {
  ...
  return (
    <div className="bg-white text-gray-900 dark:bg-black dark:text-white relative overflow-hidden">
      ...
      <div
        className={`relative z-10 container mx-auto px-6 py-12 transition-all duration-1500 ${
          ...
          >
            ...
            <div className="space-y-3">
              <div className="group flex items-center space-x-4 p-3 rounded-lg bg-white/5 backdrop-blur-sm border border-white/10 hover:border-cyan-400/50 hover:bg-white/10 transition-all duration-300 transform hover:translate-x-2">
                ...
                />
                <div>
                  <span className="text-gray-700 dark:text-gary-300 text-sm">
                    Call Us:
                  </span>
            ...
            <div className="flex space-x-4 mt-8">
              ...
              >
                <svg
                  viewBox="0 0 24 24"
                  className="w-6 h-6 fill-white group-hover:fill-black transition-colors duration-300"
                >
              ...
              >
                <svg
                  viewBox="0 0 24 24"
                  className="w-6 h-6 fill-white group-hover:fill-white transition-colors duration-300"
                >
  ...
  transform hover:translate-x-2 hover:shadow-lg hover:shadow-purple-500/20"
                ...
                >
                  <span className="font-semibold group-hover:text-purple-300 transition-colors duration-300">
                    {platform}
                  </span>
