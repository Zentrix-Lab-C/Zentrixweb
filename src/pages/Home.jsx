...
const Home = () => {
  ...
  return (
    <section
      id="home"
      className="relative w-full min-h-screen overflow-hidden bg-white text-black dark:bg-gray-900 dark:text-white"
    >
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col leading-tight opacity-50">
                  <span className="text-white font-[Orbitron] text-xl tracking-wider">
                    ZENTRIX
                  </span>
                  <span className="text-gray-300 font-[Orbitron] text-sm tracking-widest -mt-1">
                    LAB
                  </span>
                </div>
              </div>
      ...
      <div className="absolute inset-0">
        ...
        {/* Geometric shapes */}
        <div
          className="absolute top-20 left-10 w-8 h-8 border-2 border-cyan-400/30 rotate-45 animate-spin"
          style={{ animationDuration: "15s" }}
        />
        <div className="absolute top-40 right-20 w-6 h-6 border-2 border-green-400/20 animate-pulse" />
        <div
          className="absolute bottom-32 left-16 w-4 h-4 bg-blue-400/30 rounded-full animate-bounce"
      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 text-center">
        {/* Heading */}
        <div
          className={`max-w-6xl mx-auto mb-8 transform transition-all duration-1000 ${
        ...
        {/* Buttons */}
        <div
          className={`flex flex-col sm:flex-row gap-6 sm:gap-12 transform transition-all duration-1000 delay-500 ${
            textVisible
              ? "opacity-100 translate-y-0"
