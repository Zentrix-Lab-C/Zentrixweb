...
const Ventures = () => {
  ...
  const ventures = [
    {
      ...
      description:
        "next-gen AI assistant platform inspired by J.A.R.V.I.S, designed to deliver powerful, adaptive, and modular intelligence across voice, text, and real-world control systems.",
    ...
    },
    {
      ...
      description:
        "next-gen AI-powered humanoid robotics ecosystem developed by Zentrix Lab to protect, assist, simulate, and explore across multiple domains.",
    ...
    },
    {
      ...
      description:
        "hybrid lifestyle and digital services brand that delivers real-world essentials, from fashion and salon care to tech repairs and digital products under one trusted name.",
    ...
    },
    {
      ...
      description:
        "smart business & service discovery platform that connects users to verified brands, professionals, and companies worldwide, powered by location detection, trust indicators, & more",
    ...
    },
    {
      ...
      description:
        "next-gen financial super app that merges traditional banking, crypto custody, smart financial automation, and community-driven tools all in one secure platform",
  ...
  return (
    <div className="min-h-scree bg-white text-gray-900 dark:bg-gray-950 dark:text-white overflow-hidden relative">
      {/* Background gradient */}
      <div
        className={`absolute inset-0 bg-gradient-to-br from-gray-100 via-white to-gray-50 dark:from-gray-900 dark:via-gray-950 dark:to-black transition-all duration-2000 ${
      ...
      {/* Floating orbs */}
      <div
        className={`absolute top-1/4 left-1/4 w-96 h-96 bg-cyan-400/10 dark:bg-cyan-500/10 rounded-full blur-3xl transition-all duration-3000 ${
          isVisible ? "scale-100 opacity-100" : "scale-0 opacity-0"
        }`}
      />
      <div
        className={`absolute bottom-1/4 right-1/4 w-96 h-96 bg-purple-400/10 dark:bg-purple-500/10 rounded-full blur-3xl transition-all duration-3000 delay-500 ${
          isVisible ? "scale-100 opacity-100" : "scale-0 opacity-0"
        }`}
      />
      ...
      <div className="relative z-10 container mx-auto px-6 py-5">
        ...
        <div
          className={`text-center mb-10 transition-all duration-1500 ${
            isVisible
        ...
        >
          ...
          <div
            className={`w-24 h-1 bg-gradient-to-r from-cyan-400 to-purple-400 mx-auto rounded-full transition-all duration-1500 delay-300 ${
              ...
              >
                ...
                <div
                  className={`
                    ...
                    bg-gradient-to-br ${
                      venture.gradient
                    } shadow-lg relative z-10 overflow-hidden
                ...
                <div
                  className={`relative z-10 flex-1 transition-all duration-500 ${
                    hoveredCard === venture.id ? "scale-105" : "scale-100"
                  }`}
                >
                  <h2
                    className={`
                      text-2xl font-bold mb-2 bg-gradient-to-r ${
                        venture.gradient
                      } 
                  ...
                  <p
                    className={`text-sm font-semibold text-gray-400 uppercase tracking-wider mb-3 opacity-80 transition-all duration-500 ${
                      hoveredCard === venture.id
